-- =========================================================================
-- PART 1: SYSTEM SETUP (DDL & DATA INSERTION)
-- =========================================================================
...
-- Query 2: Search for users whose names start with 'Tanvir' or contain 'Haque'
SELECT user_id, full_name, email 
FROM Users 
WHERE full_name ILIKE 'Tanvir%' 
   OR full_name ILIKE '%Haque%';

-- Query 3: Retrieve missing payment statuses, replacing NULL with 'Action Required'
...
-- Query 5: Comprehensive list of all users and their bookings (including fans with no tickets)
SELECT u.user_id, u.full_name, b.booking_id 
FROM Users u
LEFT JOIN Bookings b ON u.user_id = b.user_id;

-- Query 6: Find ticket bookings where total cost is strictly higher than the average
SELECT booking_id, match_id, total_cost 
FROM Bookings 
WHERE total_cost > (SELECT AVG(total_cost) FROM Bookings);

-- Query 7: Retrieve the top 2 most expensive matches, skipping the absolute highest
SELECT match_id, fixture, base_ticket_price 
FROM Matches 
